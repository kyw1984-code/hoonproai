...
# -----------------------------------------------------------
# [중요] 1. 전역 페이지 설정 (무조건 맨 윗줄에 있어야 함)
# -----------------------------------------------------------
...
# -----------------------------------------------------------
# 4. [중요] 메인 실행 로직 (사이드바 메뉴를 먼저 그립니다!)
# -----------------------------------------------------------

# 사이드바 메뉴 그리기 (메뉴를 먼저 선언해야 오류가 안 납니다)
st.sidebar.title("📌 메뉴 선택")
menu_selection = st.sidebar.radio(
    "이동할 페이지를 선택하세요", 
    ["🏠 홈", "📊 광고 성과 분석기", "🏷️ 상품명 제조기"],
    key='current_page' # 세션 스테이트와 키를 일치시켜 연동
)
